...
class Lista: 
    ...
    def listar_variavel(self, agencia, contas, lista_self):
        ...
        if self.conta_cadastrada is False:
            self.valor_conta_variavel = contas['valor_conta_variavel']
            self.conta_variavel = contas['conta_variavel']
        ...
        if self.opcao == 'Listar' and self.conta_cadastrada is False:
            ...
            if self.conta_cadastrada is False:
                ...
                agencia.update(valor_conta_variavel=self.valor_conta_variavel)
                agencia.update(conta_variavel=self.conta_variavel)
                agencia.update(opcao_conta=self.opcao_conta)                
                agencia.update(valor_agencia=self.valor_agencia)                
            ...
            print(f'\ncadastrar_ {self.dado_variavel} {self.valor_dado_variavel} não possue cadastro.')
