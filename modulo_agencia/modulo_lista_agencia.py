...
class Lista:
    ...
    def lista_autenticacao(self, lista_self, valor_agencia_filial):   # _4.2.1
    ...
    def lista_usuario(self, lista_self, valor_agencia_filial=None):   # _4.2.2
        ...
        if cadastro_usuario is False and self.opcao == 'cadastrar':
            ...
            if encerrar == '1':
                if len(self.lista_acesso_json) == 0:
