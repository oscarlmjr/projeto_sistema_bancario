print('2.5_')
class Agencia:   # 2.5.0_
    print('2.5.0_')
    def __init__(self, valor_agencia):   # 2.5.1_
        print('2.5.1_')
    ...
    def menu_self(self, self_matriz, valor_agencia_filial):   # 2.5.2_
        print('2.5.2_')
    ...
    def menu_opcao(self, lista_self):   # 2.5.3_
        print('2.5.3_')
...
if __name__ == "__main__":
    ...
    Agencia("0003").menu_self(None, None)
